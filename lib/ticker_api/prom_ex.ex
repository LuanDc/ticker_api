defmodule TickerApi.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule TickerApiWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :ticker_api

       ...

       plug PromEx.Plug, prom_ex_module: TickerApi.PromEx
  ...
  def dashboards do
    [
      ...
      {:ticker_api, "/grafana_dashboards/postgres_metrics.json"},
      {:ticker_api, "/grafana_dashboards/redis_metrics.json"}
    ]
  end
end
